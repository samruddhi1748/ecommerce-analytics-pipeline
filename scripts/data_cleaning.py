...
# Customers
customers = pd.read_csv("s3://ecommerce-olist-dataset/raw/olist_customers_dataset.csv")

# Orders
orders = pd.read_csv("s3://ecommerce-olist-dataset/raw/olist_orders_dataset.csv")

# Products
products = pd.read_csv("s3://ecommerce-olist-dataset/raw/olist_products_dataset.csv")
